...
reStructuredText_ with its own markup_. Using these, add or update the docs as
appropriate. Then compile the HTML:

::
    $ make html

Reload the docs in your browser. If you're happy with the changes, commit and
push them. Since this project is hosted on Github, a `pull request`_ workflow
is available.
...
.. _reStructuredText: http://sphinx-doc.org/latest/rest.html#rst-primer
